...
class HousesDatabase {
  ...
  private val houses = Collections.synchronizedList(mutableListOf(
    ...
    House(4.houseId(), "Targaryen", "They ruled the seven kingdoms for 300 years with the help of their Dragons. But during the rule of the Mad King Aerys they lost their battle against Robert and Ned and lost their claim in the Iron Throne."),
    House(5.houseId(), "Greyjoy", "They are the lords of Iron Islands rule from the Pyke in the Iron Islands."),
    House(6.houseId(), "Arryn", "They are the main House of the Vale and rule form a small castle called the Eyrie in the mountain."),
    House(7.houseId(), "Martell", "They are the ruler of the Dorne , rule from the Sunspear Castle ."),
  ...
  fun createOrUpdate(postedHouse: PostHouse): Boolean {
    ...
    return if (storedHouse != null) {
      ...
      houses.add(House(
        (houses.last().houseId.id + 1).houseId(),
        postedHouse.name,
        postedHouse.description))
      true
    }
